	...
	<div class="bg-gray-50 py-16 lg:py-20">
		<div class="px-4 mx-auto max-w-3xl sm:px-6 lg:px-8">
			<figure class="text-center">
				<svg
					class="mx-auto h-10 w-10 text-blue-500/30"
					fill="currentColor"
					viewBox="0 0 32 32"
					aria-hidden="true"
				>
				...
				<blockquote class="mt-6">
					<p class="text-2xl font-medium leading-relaxed text-navy-900 sm:text-3xl sm:leading-relaxed">
						{caseStudy.testimonial.quote}
					</p>
				</blockquote>
				<figcaption class="mt-8">
					<span class="block text-base font-semibold text-navy-900"
						>{caseStudy.testimonial.author}</span
					>
					{#if caseStudy.testimonial.company}
						<span class="block text-base text-gray-500">{caseStudy.testimonial.company}</span>
					{/if}
				</figcaption>
			</figure>
		</div>
