...
<div
  class="hero-bg to-gray-100 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28"
>
    ...
    <div>
      ...
      <div class="flex flex-wrap items-start justify-between gap-8">
        <div class="mt-3 sm:mt-4">
          <p class="max-w-screen-md text-xl leading-7 text-gray-500">
            Most of the web is built on open-source projects. Since open source
            projects are such a valuable resource, we are committed to sharing
            tools we think will strengthen the web development community.
          </p>
        </div>
        <div class="mt-3 inline-flex text-gray-500 sm:mt-4">
          ...
          >
            <svg
              class="h-6 scale-90 fill-current text-gray-600 transition-all group-hover:scale-100 group-hover:text-blue-600"
              viewBox="0 0 512 512"
            ...
            <p class="max-w-screen-md leading-7">
              See all of our public projects on GitHub
            </p>
          </a>
        </div>
      </div>
    ...
    >
      <div>
        ...
        <p class="mt-3 text-base leading-6 text-gray-500">
          A tool to track whether or not your sites are up. It also keeps track
          of how often a site goes down, and for how long. An invaluable tool
          for any company that manages several sites.
        </p>
        <div class="mt-3">
          <a
      ...
      <div>
        ...
        <p class="mt-3 text-base leading-6 text-gray-500">
          Sometimes when you're migrating a site you have a lot of links you
          need to redirect somewhere else. Redirects Wizard allows you to do
          that task, but much quicker.
        </p>
        <div class="mt-3">
          <a
            class="text-base font-semibold leading-6 text-orange-600 underline-offset-2 transition duration-150 ease-in-out hover:text-orange-500 hover:underline"
