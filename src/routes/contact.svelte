...
<div class="bg-white pt-8">
  <div class="container mx-auto px-4 text-gray-700 max-w-3xl">
    <div class="prose">
      <h1
        class="mt-12 text-3xl leading-9 font-extrabold text-navy-600 sm:text-4xl sm:leading-10"
      >
        Get in touch
      </h1>
      <p>
        Set up some time to talk to Michael Bonner, the founder, not a sales
        person or an intern.
      </p>
      <p>
        We love meeting new people and hearing new ideas. Our goal is to help
        you build your website, mobile app, or web app. We'll work with you to
        understand what you need, and we'll make it happen.
      </p>
      <p>
        Do you have a project idea or an existing site that needs to be updated?
        Do you need an outside consultant? Fill out this form and we'll be in
        touch. We specialize in custom web design, web development, and app
        development.
      </p>
    </div>
        ...
        <div>
          ...
          >
            <span class="mx-2 text-white flex items-end">
              ...
              >
                <g
                  transform="matrix(1.3743674 0 0 1.3743674 -4.586789 185.07591)"
                >
                  <path
                    class="st0"
    ...
    <section
      class="w-full max-w-3xl mx-auto pt-6 lg:pt-8 pb-24 mt-8 lg:mt-12 border-t"
    >
      <ContactForm />
    </section>
  </div>
