...
<div
  class="bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 py-4 lg:py-24"
>
  <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8">
    <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
      <div class="lg:mt-8">
        ...
        <p class="mt-3">
          <a class="underline text-lg text-blue-500" href="/work/"
            >See some of our work</a
          >
        </p>
      </div>
      <div
        class="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 items-center"
      >
