  ...
  const handleSubmit = async (event: SubmitEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        errorMessage =
          data?.error ??
          "Oops! There was a problem submitting your application";
  ...
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
    ...
    <div>
      <label class={labelClass} for="organizationName">
        Organization Name <span aria-hidden="true" class="text-orange-600"
          >*</span
        >
      </label>
      <input
      ...
      >
        ...
        >
          ...
          <option value="Faith-based organization"
            >Faith-based organization</option
          >
          <option value="LGBTQIA+ support organization"
            >LGBTQIA+ support organization</option
          >
          <option value="Mutual aid / grassroots group"
            >Mutual aid / grassroots group</option
          >
